...
const yargsconfig = yargs
    ...
    .command('login', 'Log in to a node')
    .command('nodes', 'List nodes')
    .command('restart', 'Restarts application in environment')
    .example('skya login t4 henvendelse', 'Log into henvendelse in t4. Prompts you if more than one node')
    .example('skya login t1 henvendelse 1', 'Log into the first node of henvendelse in t1 ')
